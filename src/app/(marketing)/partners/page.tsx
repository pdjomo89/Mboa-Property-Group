...
export default async function PartnersPage() {
  ...
  const partners: Array<{
    ...
    { name: "AfriNovaTech Consulting", category: "IT Consulting", icon: Code2, gradient: "from-violet-500 to-indigo-500", soft: "from-violet-50 to-indigo-50", ring: "ring-violet-200" },
